...
st.title("Clasificador con Redes Neuronales")
st.write("Se usara un Perceptron Multi-Capa (MLP), como red neuronal para la clasificacion")
...
if archivo is not None:
    ...
    st.subheader("Forma de Capas de la Red:")

    col_a, col_b = st.columns(2)
    nodos_n = col_a.number_input("Ingrese la cantidad de n nodos:",1,None,50,1)
    nodos_m = col_b.number_input("Ingrese la cantidad de m nodos:",1,None,50,1)
    ...
    if st.button('Calcular'):
            ...
            classifier = MLPClassifier(hidden_layer_sizes=(nodos_n,nodos_m))
            ...
            plt.title("Clasificador con Redes Neuronales")
            st.subheader("Grafica:")
            st.pyplot(grafica)


            #st.subheader("Arbol:")
            #dot_tree = export_graphviz(classifier, out_file=None)
